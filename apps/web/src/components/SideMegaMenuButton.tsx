...
export function SideMegaMenuButton() {
  ...
  return (
    <div className="relative z-40 w-full max-w-72">
      <button
        ...
        aria-controls="side-mega-menu-button"
      >
      ...
      {isOpen ? (
        <div
          id="side-mega-menu-button"
          className="absolute left-0 top-full mt-2 flex w-[min(1040px,calc(100vw-2rem))] overflow-hidden rounded-lg border border-slate-200 bg-white shadow-xl"
        >
          ...
          <div className="min-h-96 flex-1 p-5">
...
export default SideMegaMenuButton;
